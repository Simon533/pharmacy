...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('medicine purchase',compact(
            'title','products',
        ));
    }
    ...
    public function expired(){
        ...
        return view('expiredmedicine',compact(
            'title','products'
        ));
    }
    ...
    public function outstock(){
        ...
        return view('medicine outstock',compact(
            'title','products',
        ));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('add-medicine')->with($notification);
    }
